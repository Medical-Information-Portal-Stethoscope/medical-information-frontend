...
const meta: Meta<typeof CardArticlePreview> = {
  ...
  argTypes: {
    data: {
      ...
      created_at: {
        description: 'Дата добавления статьи в БД',
        type: 'string',
      },
      author: {
        description: 'Автор',
...
export const Media: TStory = {
  args: {
    data: {
      ...
      annotation:
        'Использование зубной нити является важной частью гигиены полости рта. Пользоваться нитью довольно просто, но важно правильно ее использовать, чтобы не повредить зубы и десны. Перед вами подробное руководство по использованию зубной нити.',
